...
define dso_local i32 @main() #0 {
  ...
  %4 = call noalias i8* @malloc(i64 60) #6
  %5 = bitcast i8* %4 to i32*
  store i32* %5, i32** %2, align 8, !tbaa !55
  %6 = load i32*, i32** %2, align 8, !tbaa !55
  %7 = icmp ne i32* %6, null
  br i1 %7, label %8, label %17

8:                                                ; preds = %0
  %9 = load i32*, i32** %2, align 8, !tbaa !55
  %10 = getelementptr inbounds i32, i32* %9, i64 5
  store i32 480, i32* %10, align 4, !tbaa !59
  %11 = load i32*, i32** %2, align 8, !tbaa !55
  %12 = getelementptr inbounds i32, i32* %11, i64 5
  %13 = load i32, i32* %12, align 4, !tbaa !59
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str, i64 0, i64 0), i32 %13)
  %15 = load i32*, i32** %2, align 8, !tbaa !55
...
define void @__seahorn_UAF_init() local_unnamed_addr #0 !dbg !61 {
  %1 = tail call i8* @__seahorn_UAF_nondet_ptr() #6, !dbg !64
  store i8* %1, i8** @__seahorn_UAF_bgn, align 8, !dbg !65, !tbaa !55
  %2 = tail call i8* @__seahorn_UAF_nondet_ptr() #6, !dbg !66
  store i8* %2, i8** @__seahorn_UAF_end, align 8, !dbg !67, !tbaa !55
  ret void, !dbg !68
}

declare i8* @__seahorn_UAF_nondet_ptr() local_unnamed_addr #3
...
3:                                                ; preds = %1
  %4 = tail call zeroext i1 @__seahorn_UAF_nondet() #6, !dbg !79
...
declare zeroext i1 @__seahorn_UAF_nondet() local_unnamed_addr #3

; Function Attrs: noinline nounwind optnone uwtable
define i8* @__seahorn_UAF_malloc2(i64 %0) local_unnamed_addr #5 !dbg !97 {
  %2 = alloca i8*, align 8
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %7) #6, !dbg !105
...
11:                                               ; preds = %1
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %21) #6, !dbg !124
...
27:                                               ; preds = %22
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %28) #6, !dbg !131
  br label %38
...
43:                                               ; preds = %38, %10
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %44) #6, !dbg !147
...
declare void @__SEA_assume(i1 zeroext) local_unnamed_addr #3
...
3:                                                ; preds = %1
  ...
  tail call void @__SEA_assume(i1 zeroext %6) #6, !dbg !159
  %7 = load i64, i64* @__seahorn_allocationCount, align 8, !dbg !160, !tbaa !84
  %8 = icmp ult i64 %7, 100, !dbg !161
  tail call void @__SEA_assume(i1 zeroext %8) #6, !dbg !162
...
define i8* @__seahorn_UAF_malloc4(i64 %0) local_unnamed_addr #0 !dbg !177 {
  ...
  tail call void @__SEA_assume(i1 zeroext %4) #6, !dbg !185
  %5 = tail call i8* @__seahorn_UAF_malloc_redir(i64 %0) #6, !dbg !186
...
8:                                                ; preds = %1
  %9 = tail call zeroext i1 @__seahorn_UAF_nondet() #6, !dbg !193
...
10:                                               ; preds = %8
  ...
  tail call void @__SEA_assume(i1 zeroext %12) #6, !dbg !199
...
18:                                               ; preds = %15, %10
  ...
  tail call void @__SEA_assume(i1 zeroext %19) #6, !dbg !207
  ret i8* %5, !dbg !208
}

declare i8* @__seahorn_UAF_malloc_redir(i64) local_unnamed_addr #3
...
6:                                                ; preds = %2
  ...
  %9 = or i1 %7, %8, !dbg !224
  call void @llvm.dbg.value(metadata i64 %4, metadata !73, metadata !DIExpression()) #6, !dbg !225
...
12:                                               ; preds = %6, %10
  %13 = tail call zeroext i1 @__seahorn_UAF_nondet() #6, !dbg !227
...
18:                                               ; preds = %14
  ...
  call void @llvm.dbg.value(metadata i8* %19, metadata !74, metadata !DIExpression()) #6, !dbg !225
...
8:                                                ; preds = %3
  tail call void @__VERIFIER_error() #6, !dbg !251
  br label %9, !dbg !251
...
declare void @__VERIFIER_error() local_unnamed_addr #3
...
9:                                                ; preds = %3
  tail call void @__VERIFIER_error() #6, !dbg !267
...
16:                                               ; preds = %10
  tail call void @__VERIFIER_error() #6, !dbg !270
  br label %17, !dbg !270
...
23:                                               ; preds = %16
  tail call void @__VERIFIER_error() #6, !dbg !297
  br label %24, !dbg !297
...
28:                                               ; preds = %24
  tail call void @__VERIFIER_error() #6, !dbg !299
  br label %29, !dbg !299
...
7:                                                ; preds = %1
  ...
  tail call void @__SEA_assume(i1 zeroext %9) #6, !dbg !314
...
12:                                               ; preds = %7
  tail call void @__VERIFIER_error() #6, !dbg !315
  br label %13, !dbg !315
...
5:                                                ; preds = %2
  call void @llvm.dbg.value(metadata i64 %1, metadata !73, metadata !DIExpression()) #6, !dbg !333
  br i1 %4, label %47, label %6, !dbg !335

6:                                                ; preds = %5
  %7 = tail call zeroext i1 @__seahorn_UAF_nondet() #6, !dbg !336
...
12:                                               ; preds = %8
  ...
  call void @llvm.dbg.value(metadata i8* %13, metadata !74, metadata !DIExpression()) #6, !dbg !333
...
19:                                               ; preds = %18
  call void @llvm.dbg.value(metadata i8* %0, metadata !245, metadata !DIExpression()) #6, !dbg !350
  %20 = getelementptr inbounds i8, i8* %0, i64 -8, !dbg !354
  call void @llvm.dbg.value(metadata i8* %20, metadata !245, metadata !DIExpression()) #6, !dbg !350
...
24:                                               ; preds = %19
  tail call void @__VERIFIER_error() #6, !dbg !355
  br label %25, !dbg !355
...
26:                                               ; preds = %18
  call void @llvm.dbg.value(metadata i64 %1, metadata !73, metadata !DIExpression()) #6, !dbg !360
  %27 = tail call zeroext i1 @__seahorn_UAF_nondet() #6, !dbg !362
...
32:                                               ; preds = %28
  ...
  call void @llvm.dbg.value(metadata i8* %33, metadata !74, metadata !DIExpression()) #6, !dbg !360
  ...
  call void @llvm.dbg.value(metadata i8* %0, metadata !245, metadata !DIExpression()) #6, !dbg !381
  call void @llvm.dbg.value(metadata i8* %38, metadata !245, metadata !DIExpression()) #6, !dbg !381
  %43 = load i64, i64* %39, align 8, !dbg !383, !tbaa !84
  %44 = icmp eq i64 %43, 0, !dbg !383
  br i1 %44, label %45, label %46, !dbg !383

45:                                               ; preds = %32
  tail call void @__VERIFIER_error() #6, !dbg !383
  br label %46, !dbg !383
...
6:                                                ; preds = %1
  tail call void @__VERIFIER_error() #6, !dbg !392
  br label %7, !dbg !392
...
7:                                                ; preds = %1
  tail call void @__VERIFIER_error() #6, !dbg !398
  br label %8, !dbg !398
...
22:                                               ; preds = %19
  tail call void @__VERIFIER_error() #6, !dbg !418
  br label %23, !dbg !418
...
29:                                               ; preds = %23
  tail call void @__VERIFIER_error() #6, !dbg !421
  br label %30, !dbg !421
...
; Function Attrs: noinline nounwind optnone uwtable
define void @__seahorn_UAF_use_prehook4(i8* %0) local_unnamed_addr #5 !dbg !423 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define void @__seahorn_UAF_memset_fake(i8* %0, i8 signext %1, i64 %2, i1 zeroext %3) local_unnamed_addr #5 !dbg !446 {
  %5 = alloca i8*, align 8
  %6 = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define void @__seahorn_UAF_memset_real(i8* %0, i8 signext %1, i64 %2, i1 zeroext %3) local_unnamed_addr #5 !dbg !461 {
  %5 = alloca i8*, align 8
  %6 = alloca i8, align 1
  %7 = alloca i64, align 8
  %8 = alloca i8, align 1
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %12) #6, !dbg !475
...
18:                                               ; preds = %13
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %19) #6, !dbg !482
  br label %29
...
; Function Attrs: noinline nounwind optnone uwtable
define void @__seahorn_UAF_memcpy_fake(i8* %0, i8* %1, i64 %2, i1 zeroext %3) local_unnamed_addr #5 !dbg !491 {
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
  %7 = alloca i64, align 8
  %8 = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define void @__seahorn_UAF_memcpy_real(i8* %0, i8* %1, i64 %2, i1 zeroext %3) local_unnamed_addr #5 !dbg !508 {
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
  %7 = alloca i64, align 8
  %8 = alloca i8, align 1
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %13) #6, !dbg !524
...
19:                                               ; preds = %14
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %20) #6, !dbg !531
  br label %34
