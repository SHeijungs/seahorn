...
void MemUfoOpSem::execCallSite(CallSiteInfo &csi, ExprVector &side,
  ...
  NodeSet &unsafeCallerNodes = m_preproc->getUnsafeCallerNodesCallSite(CB);
  SimulationMapper &simMap = m_preproc->getSimulationCallSite(CB);
